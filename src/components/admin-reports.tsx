...
import { shopStore, shiftStore, jobStore, calculateFee, type CashierShift } from "@/lib/store";
...
export function AdminReports({ onViewJob }: AdminReportsProps) {
  ...
  // Sub-tabs state
  const [subTab, setSubTab] = useState<"overview" | "shift" | "order" | "pos" | "customer" | "promo">("overview");
  ...
  // 5. Promo Code Report calculations
  ...
  return (
    <div className="flex-1 p-6 space-y-6 overflow-y-auto max-h-[calc(100vh-4rem)] bg-slate-50 dark:bg-slate-900 font-sans">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          >
            ...
            {subTab === "overview" ? "Print Overview" :
             ...
             subTab === "customer" ? "Print Customer Report" :
             subTab === "promo" ? "Print Promo Report" : "Print Report"}
          </button>
        </div>
      </div>
      ...
      {/* 6. PROMO CODE PERFORMANCE REPORT */}
      {subTab === "promo" && (
        <div className="space-y-6 animate-in fade-in duration-200">
          {/* Executive KPI Cards */}
