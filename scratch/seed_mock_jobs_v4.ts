...
async function main() {
  ...
  for (let i = 0; i < 100; i++) {
    ...
    jobsToCreate.push({
      ...
      dropoffLocation: customer.defaultAddress || "Customer Address", // MUST BE CUSTOMER ADDRESS FOR FULL SERVICE
  ...
  console.log("✅ Successfully seeded 200 jobs with correct 2-way data and formulas!");
}
